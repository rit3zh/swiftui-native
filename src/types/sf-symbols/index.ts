...
export type SFSymbol = Overrides extends { SFSymbolsVersion: "1.0" }
  ? SFSymbols1_0
  : Overrides extends { SFSymbolsVersion: "1.1" }
  ? SFSymbols1_1
  : Overrides extends { SFSymbolsVersion: "2.0" }
  ? SFSymbols2_0
  : Overrides extends { SFSymbolsVersion: "2.1" }
  ? SFSymbols2_1
  : Overrides extends { SFSymbolsVersion: "2.2" }
  ? SFSymbols2_2
  : Overrides extends { SFSymbolsVersion: "3.0" }
  ? SFSymbols3_0
  : Overrides extends { SFSymbolsVersion: "3.1" }
  ? SFSymbols3_1
  : Overrides extends { SFSymbolsVersion: "3.2" }
  ? SFSymbols3_2
  : Overrides extends { SFSymbolsVersion: "3.3" }
  ? SFSymbols3_3
  : Overrides extends { SFSymbolsVersion: "4.0" }
  ? SFSymbols4_0
  : Overrides extends { SFSymbolsVersion: "4.1" }
  ? SFSymbols4_1
  : Overrides extends { SFSymbolsVersion: "4.2" }
  ? SFSymbols4_2
  : Overrides extends { SFSymbolsVersion: "5.0" }
  ? SFSymbols5_0
  : Overrides extends { SFSymbolsVersion: "5.1" }
  ? SFSymbols5_1
  : Overrides extends { SFSymbolsVersion: "5.2" }
  ? SFSymbols5_2
  : Overrides extends { SFSymbolsVersion: "5.3" }
  ? SFSymbols5_3
  : Overrides extends { SFSymbolsVersion: "6.0" }
  ? SFSymbols6_0
  : SFSymbols6_0;
